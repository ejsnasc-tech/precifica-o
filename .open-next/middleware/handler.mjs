...
var require_middleware = __commonJS({
  ".next/server/src/middleware.js"() {
    ...
    (self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[550], { 165: (a, b, c) => {
      ...
      "use strict";
      let d, e;
      c.r(b), c.d(b, { default: () => cg });
      var f, g = {};
      async function h() {
        return "_ENTRIES" in globalThis && _ENTRIES.middleware_instrumentation && await _ENTRIES.middleware_instrumentation;
      }
      c.r(g), c.d(g, { config: () => cc, middleware: () => cb });
      let i = null;
      async function j() {
...
Learn More: https://nextjs.org/docs/messages/node-module-in-edge-runtime`;
  ...
  `);
      ...
      let b4 = { current: null }, b5 = "function" == typeof bi.cache ? bi.cache : (a10) => a10, b6 = console.warn;
      function b7(a10) {
        return function(...b10) {
          b6(a10(...b10));
        };
      ...
      }), /* @__PURE__ */ new WeakMap(), b7(function(a10, b10) {
      ...
      let b8 = new TextEncoder().encode(process.env.JWT_SECRET ?? "precificacao-pro-secret-dev");
      async function b9(a10) {
        try {
          let { payload: b10 } = await b3(a10, b8);
          return b10;
        } catch {
          return null;
        }
      }
      let ca = ["/login", "/cadastro", "/api/auth/login", "/api/auth/register"];
      async function cb(a10) {
        let { pathname: b10 } = a10.nextUrl;
        if (ca.some((a11) => b10.startsWith(a11))) return T.next();
        let c2 = a10.cookies.get("pp_token")?.value;
        return c2 && await b9(c2) ? T.next() : T.redirect(new URL("/login", a10.url));
      }
      let cc = { matcher: ["/((?!_next/static|_next/image|favicon.ico).*)"] };
      Object.values({ NOT_FOUND: 404, FORBIDDEN: 403, UNAUTHORIZED: 401 });
      let cd = { ...g }, ce = cd.middleware || cd.default, cf = "/src/middleware";
      if ("function" != typeof ce) throw Object.defineProperty(Error(`The Middleware "${cf}" must export a \`middleware\` or a \`default\` function`), "__NEXT_ERROR_CODE", { value: "E120", enumerable: false, configurable: true });
      function cg(a10) {
        return bh({ ...a10, page: cf, handler: async (...a11) => {
          try {
            return await ce(...a11);
          } catch (e2) {
...
var NextConfig = { "env": {}, "webpack": null, "eslint": { "ignoreDuringBuilds": false }, "typescript": { "ignoreBuildErrors": false, "tsconfigPath": "tsconfig.json" }, "typedRoutes": false, "distDir": ".next", "cleanDistDir": true, "assetPrefix": "", "cacheMaxMemorySize": 52428800, "configOrigin": "next.config.ts", "useFileSystemPublicRoutes": true, "generateEtags": true, "pageExtensions": ["tsx", "ts", "jsx", "js"], "poweredByHeader": true, "compress": true, "images": { "deviceSizes": [640, 750, 828, 1080, 1200, 1920, 2048, 3840], "imageSizes": [16, 32, 48, 64, 96, 128, 256, 384], "path": "/_next/image", "loader": "default", "loaderFile": "", "domains": [], "disableStaticImages": false, "minimumCacheTTL": 60, "formats": ["image/webp"], "maximumResponseBody": 5e7, "dangerouslyAllowSVG": false, "contentSecurityPolicy": "script-src 'none'; frame-src 'none'; sandbox;", "contentDispositionType": "attachment", "remotePatterns": [], "unoptimized": false }, "devIndicators": { "position": "bottom-left" }, "onDemandEntries": { "maxInactiveAge": 6e4, "pagesBufferLength": 5 }, "amp": { "canonicalBase": "" }, "basePath": "", "sassOptions": {}, "trailingSlash": false, "i18n": null, "productionBrowserSourceMaps": false, "excludeDefaultMomentLocales": true, "serverRuntimeConfig": {}, "publicRuntimeConfig": {}, "reactProductionProfiling": false, "reactStrictMode": null, "reactMaxHeadersLength": 6e3, "httpAgentOptions": { "keepAlive": true }, "logging": {}, "compiler": {}, "expireTime": 31536e3, "staticPageGenerationTimeout": 60, "output": "standalone", "modularizeImports": { "@mui/icons-material": { "transform": "@mui/icons-material/{{member}}" }, "lodash": { "transform": "lodash/{{member}}" } }, "outputFileTracingRoot": "C:\\Users\\JOGOS\\Desktop\\projetos\\precificacao-pro", "experimental": { "useSkewCookie": false, "cacheLife": { "default": { "stale": 300, "revalidate": 900, "expire": 4294967294 }, "seconds": { "stale": 30, "revalidate": 1, "expire": 60 }, "minutes": { "stale": 300, "revalidate": 60, "expire": 3600 }, "hours": { "stale": 300, "revalidate": 3600, "expire": 86400 }, "days": { "stale": 300, "revalidate": 86400, "expire": 604800 }, "weeks": { "stale": 300, "revalidate": 604800, "expire": 2592e3 }, "max": { "stale": 300, "revalidate": 2592e3, "expire": 4294967294 } }, "cacheHandlers": {}, "cssChunking": true, "multiZoneDraftMode": false, "appNavFailHandling": false, "prerenderEarlyExit": true, "serverMinification": true, "serverSourceMaps": false, "linkNoTouchStart": false, "caseSensitiveRoutes": false, "clientSegmentCache": false, "clientParamParsing": false, "dynamicOnHover": false, "preloadEntriesOnStart": true, "clientRouterFilter": true, "clientRouterFilterRedirects": false, "fetchCacheKeyPrefix": "", "middlewarePrefetch": "flexible", "optimisticClientCache": true, "manualClientBasePath": false, "cpus": 23, "memoryBasedWorkersCount": false, "imgOptConcurrency": null, "imgOptTimeoutInSeconds": 7, "imgOptMaxInputPixels": 268402689, "imgOptSequentialRead": null, "imgOptSkipMetadata": null, "isrFlushToDisk": true, "workerThreads": false, "optimizeCss": false, "nextScriptWorkers": false, "scrollRestoration": false, "externalDir": false, "disableOptimizedLoading": false, "gzipSize": true, "craCompat": false, "esmExternals": true, "fullySpecified": false, "swcTraceProfiling": false, "forceSwcTransforms": false, "largePageDataBytes": 128e3, "typedEnv": false, "parallelServerCompiles": false, "parallelServerBuildTraces": false, "ppr": false, "authInterrupts": false, "webpackMemoryOptimizations": false, "optimizeServerReact": true, "viewTransition": false, "routerBFCache": false, "removeUncaughtErrorAndRejectionListeners": false, "validateRSCRequestHeaders": false, "staleTimes": { "dynamic": 0, "static": 300 }, "serverComponentsHmrCache": true, "staticGenerationMaxConcurrency": 8, "staticGenerationMinPagesPerWorker": 25, "cacheComponents": false, "inlineCss": false, "useCache": false, "globalNotFound": false, "devtoolSegmentExplorer": true, "browserDebugInfoInTerminal": false, "optimizeRouterScrolling": false, "middlewareClientMaxBodySize": 10485760, "optimizePackageImports": ["lucide-react", "date-fns", "lodash-es", "ramda", "antd", "react-bootstrap", "ahooks", "@ant-design/icons", "@headlessui/react", "@headlessui-float/react", "@heroicons/react/20/solid", "@heroicons/react/24/solid", "@heroicons/react/24/outline", "@visx/visx", "@tremor/react", "rxjs", "@mui/material", "@mui/icons-material", "recharts", "react-use", "effect", "@effect/schema", "@effect/platform", "@effect/platform-node", "@effect/platform-browser", "@effect/platform-bun", "@effect/sql", "@effect/sql-mssql", "@effect/sql-mysql2", "@effect/sql-pg", "@effect/sql-sqlite-node", "@effect/sql-sqlite-bun", "@effect/sql-sqlite-wasm", "@effect/sql-sqlite-react-native", "@effect/rpc", "@effect/rpc-http", "@effect/typeclass", "@effect/experimental", "@effect/opentelemetry", "@material-ui/core", "@material-ui/icons", "@tabler/icons-react", "mui-core", "react-icons/ai", "react-icons/bi", "react-icons/bs", "react-icons/cg", "react-icons/ci", "react-icons/di", "react-icons/fa", "react-icons/fa6", "react-icons/fc", "react-icons/fi", "react-icons/gi", "react-icons/go", "react-icons/gr", "react-icons/hi", "react-icons/hi2", "react-icons/im", "react-icons/io", "react-icons/io5", "react-icons/lia", "react-icons/lib", "react-icons/lu", "react-icons/md", "react-icons/pi", "react-icons/ri", "react-icons/rx", "react-icons/si", "react-icons/sl", "react-icons/tb", "react-icons/tfi", "react-icons/ti", "react-icons/vsc", "react-icons/wi"], "trustHostHeader": false, "isExperimentalCompile": false }, "htmlLimitedBots": "[\\w-]+-Google|Google-[\\w-]+|Chrome-Lighthouse|Slurp|DuckDuckBot|baiduspider|yandex|sogou|bitlybot|tumblr|vkShare|quora link preview|redditbot|ia_archiver|Bingbot|BingPreview|applebot|facebookexternalhit|facebookcatalog|Twitterbot|LinkedInBot|Slackbot|Discordbot|WhatsApp|SkypeUriPreview|Yeti|googleweblight", "bundlePagesRouterDependencies": false, "configFileName": "next.config.ts", "serverExternalPackages": ["bcryptjs", "better-sqlite3"], "turbopack": { "root": "C:\\Users\\JOGOS\\Desktop\\projetos\\precificacao-pro" } };
var BuildId = "mqmPbCMayc0MiZ9tJNmrZ";
var RoutesManifest = { "basePath": "", "rewrites": { "beforeFiles": [], "afterFiles": [], "fallback": [] }, "redirects": [{ "source": "/:path+/", "destination": "/:path+", "internal": true, "statusCode": 308, "regex": "^(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))/$" }], "routes": { "static": [{ "page": "/", "regex": "^/(?:/)?$", "routeKeys": {}, "namedRegex": "^/(?:/)?$" }, { "page": "/_not-found", "regex": "^/_not\\-found(?:/)?$", "routeKeys": {}, "namedRegex": "^/_not\\-found(?:/)?$" }, { "page": "/cadastro", "regex": "^/cadastro(?:/)?$", "routeKeys": {}, "namedRegex": "^/cadastro(?:/)?$" }, { "page": "/dashboard", "regex": "^/dashboard(?:/)?$", "routeKeys": {}, "namedRegex": "^/dashboard(?:/)?$" }, { "page": "/favicon.ico", "regex": "^/favicon\\.ico(?:/)?$", "routeKeys": {}, "namedRegex": "^/favicon\\.ico(?:/)?$" }, { "page": "/login", "regex": "^/login(?:/)?$", "routeKeys": {}, "namedRegex": "^/login(?:/)?$" }], "dynamic": [{ "page": "/api/catalogo-ingredientes/[id]", "regex": "^/api/catalogo\\-ingredientes/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/catalogo\\-ingredientes/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/api/configuracoes/[empresaId]", "regex": "^/api/configuracoes/([^/]+?)(?:/)?$", "routeKeys": { "nxtPempresaId": "nxtPempresaId" }, "namedRegex": "^/api/configuracoes/(?<nxtPempresaId>[^/]+?)(?:/)?$" }, { "page": "/api/empresas/[id]", "regex": "^/api/empresas/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/empresas/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/api/gastos-variaveis/[id]", "regex": "^/api/gastos\\-variaveis/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/gastos\\-variaveis/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/api/ingredientes/[id]", "regex": "^/api/ingredientes/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/ingredientes/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/api/lancamentos/[id]", "regex": "^/api/lancamentos/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/lancamentos/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/api/produtos/[id]", "regex": "^/api/produtos/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/produtos/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/api/socios/[empresaId]", "regex": "^/api/socios/([^/]+?)(?:/)?$", "routeKeys": { "nxtPempresaId": "nxtPempresaId" }, "namedRegex": "^/api/socios/(?<nxtPempresaId>[^/]+?)(?:/)?$" }, { "page": "/empresa/[id]", "regex": "^/empresa/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/empresa/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/empresa/[id]/financeiro", "regex": "^/empresa/([^/]+?)/financeiro(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/empresa/(?<nxtPid>[^/]+?)/financeiro(?:/)?$" }], "data": { "static": [], "dynamic": [] } }, "locales": [] };
var ConfigHeaders = [];
var PrerenderManifest = { "version": 4, "routes": { "/favicon.ico": { "initialHeaders": { "cache-control": "public, max-age=0, must-revalidate", "content-type": "image/x-icon", "x-next-cache-tags": "_N_T_/layout,_N_T_/favicon.ico/layout,_N_T_/favicon.ico/route,_N_T_/favicon.ico" }, "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/favicon.ico", "dataRoute": null, "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/dashboard": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/dashboard", "dataRoute": "/dashboard.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/cadastro": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/cadastro", "dataRoute": "/cadastro.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/_not-found": { "initialStatus": 404, "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/_not-found", "dataRoute": "/_not-found.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/login": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/login", "dataRoute": "/login.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] } }, "dynamicRoutes": {}, "notFoundRoutes": [], "preview": { "previewModeId": "70f1d5f73f48fd2e4d079e8d974c46ad", "previewModeSigningKey": "cd958d7ef988564aa92254f1f51d44bb04898c7fbeda9e7df4f3e98d8914564f", "previewModeEncryptionKey": "dd27c11c23843b7455e701592e55739175f1b53dd617ba9f6954e8bd9206caac" } };
var MiddlewareManifest = { "version": 3, "middleware": { "/": { "files": ["server/edge-runtime-webpack.js", "server/src/middleware.js"], "name": "src/middleware", "page": "/", "matchers": [{ "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/((?!_next\\/static|_next\\/image|favicon.ico).*))(\\.json)?[\\/#\\?]?$", "originalSource": "/((?!_next/static|_next/image|favicon.ico).*)" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "mqmPbCMayc0MiZ9tJNmrZ", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "Ws8WikxsML4Yh23pGRhacJODSEPIfTyKDm/4woEJaOg=", "__NEXT_PREVIEW_MODE_ID": "70f1d5f73f48fd2e4d079e8d974c46ad", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "cd958d7ef988564aa92254f1f51d44bb04898c7fbeda9e7df4f3e98d8914564f", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "dd27c11c23843b7455e701592e55739175f1b53dd617ba9f6954e8bd9206caac" } } }, "functions": {}, "sortedMiddleware": ["/"] };
var AppPathRoutesManifest = { "/api/auth/logout/route": "/api/auth/logout", "/api/auth/login/route": "/api/auth/login", "/api/catalogo-ingredientes/[id]/route": "/api/catalogo-ingredientes/[id]", "/_not-found/page": "/_not-found", "/api/configuracoes/[empresaId]/route": "/api/configuracoes/[empresaId]", "/api/auth/register/route": "/api/auth/register", "/api/catalogo-ingredientes/route": "/api/catalogo-ingredientes", "/api/empresas/route": "/api/empresas", "/api/lancamentos/[id]/route": "/api/lancamentos/[id]", "/api/empresas/[id]/route": "/api/empresas/[id]", "/api/gastos-variaveis/[id]/route": "/api/gastos-variaveis/[id]", "/api/lancamentos/route": "/api/lancamentos", "/api/produtos/route": "/api/produtos", "/api/socios/[empresaId]/route": "/api/socios/[empresaId]", "/api/ingredientes/route": "/api/ingredientes", "/api/gastos-variaveis/route": "/api/gastos-variaveis", "/api/produtos/[id]/route": "/api/produtos/[id]", "/api/ingredientes/[id]/route": "/api/ingredientes/[id]", "/favicon.ico/route": "/favicon.ico", "/empresa/[id]/financeiro/page": "/empresa/[id]/financeiro", "/cadastro/page": "/cadastro", "/page": "/", "/empresa/[id]/page": "/empresa/[id]", "/login/page": "/login", "/dashboard/page": "/dashboard" };
