          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow p-6">
                ...
                <div className="mb-4">
                  ...
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      className={`flex-1 py-2 rounded-xl font-semibold text-sm transition-colors ${formLanc.pagamento === "cartao" ? "bg-violet-600 text-white" : "bg-slate-100 text-slate-500 hover:bg-slate-200"}`}>
                      💳 Cartão de crédito
                    </button>
                  </div>
                </div>
              ...
              {formLanc.tipo === "despesa" && formLanc.pagamento === "cartao" && (
                cartoes.length === 0 ? (
                  <div className="mb-4 bg-violet-50 border border-violet-200 rounded-xl p-4 flex items-center justify-between gap-3">
                    <div>
                      <p className="text-sm font-semibold text-violet-700">Nenhum cartão cadastrado</p>
                      <p className="text-xs text-violet-500 mt-0.5">Cadastre um cartão primeiro para lançar compras parceladas.</p>
                    </div>
                    <button onClick={() => setAba("cartoes")}
                      className="shrink-0 bg-violet-600 hover:bg-violet-700 text-white text-xs font-bold px-4 py-2 rounded-lg transition">
                      Ir para Cartões →
                    </button>
                  </div>
                ) : (
